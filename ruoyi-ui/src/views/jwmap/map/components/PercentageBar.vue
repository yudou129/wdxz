...
.pct-name { width: 72px; color: #444; flex-shrink: 0; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; font-size: 14px; }
...
.pct-tooltip { position: absolute; bottom: 100%; left: 78px; background: rgba(0,0,0,0.78); color: #fff; padding: 3px 8px; border-radius: 4px; font-size: 12px; white-space: nowrap; z-index: 10; pointer-events: none; }
